...
the setting activation. The v0.9.8 pipeline published and locked the exact 14
expected assets after its
[native release audit](https://github.com/blisspixel/quotabot/actions/runs/30692524913),
then passed the three-OS
[published install smoke](https://github.com/blisspixel/quotabot/actions/runs/30693794794).
