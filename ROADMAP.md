...
The current line, **0.5.11**, is best
...
28. [ ] 1.0 release candidate dry run. Build artifacts from a tag candidate,
    ...
    were verified; the current patch source line is `0.5.11` for the near-zero
    headroom availability fix; `gh attestation verify` passed for the downloaded
