...
- Official release artifacts carry checksum sidecars and restricted workflow
  ...
  Its exact 14-asset set is locked
  ([release 32290931121](https://github.com/blisspixel/quotabot/actions/runs/32290931121))
  and passed the three-OS
  [install smoke 32299292058](https://github.com/blisspixel/quotabot/actions/runs/32299292058)
  including upgrade from
