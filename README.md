...
> **Current release candidate:** 0.10.0-rc.2.
...
The 0.10.0-rc.2 Claude login flow uses the 32-byte OAuth state confirmed by the
...
the callback page returns a `code#state` value and the grant is stored.
